...
public class FonctionTest {
    ...
    public void testToDoListe(){
        ...
        ToDoListe to3 = null;
        System.out.println("Ajout normal to1 : " + doc.getMalistetodo().ajouterToDoListe(to1));
        System.out.println("Ajout normal to2 : " + doc.getMalistetodo().ajouterToDoListe(to2));
        System.out.println("Ajout anormal to2 : " + doc.getMalistetodo().ajouterToDoListe(to2));
        System.out.println("Ajout anormal to2 : " + doc.getMalistetodo().ajouterToDoListe(to3));
        System.out.println(doc.getMalistetodo().toString());
        System.out.println("Suppr normal to1 : " + doc.getMalistetodo().supprimerToDoListe(to1));
        System.out.println("Suppr anormal to1 : " + doc.getMalistetodo().supprimerToDoListe(to1));
        System.out.println(doc.getMalistetodo().toString());
        System.out.println("Modif normal to2 : " + doc.getMalistetodo().modifierNomToDoListe(to2, "todoliste2bis"));
        System.out.println(doc.getMalistetodo().toString());
